...
def test_get_mask_card_number() -> None:
    ...
    assert get_mask_card_number(
        "123456781234567") == "This card number is NOT correct. It should have 16 numbers. Try again."
    assert get_mask_card_number(
        "12345678123456789") == "This card number is NOT correct. It should have 16 numbers. Try again."
